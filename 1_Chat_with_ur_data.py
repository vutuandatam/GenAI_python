...
def main():
    ...
    # Upload csv file
    with st.sidebar:
        uploaded_file = st.file_uploader("Upload ur file here", type="csv")
    ...
    if uploaded_file is not None:
        ...
        st.write("Ur uploaded data : ", st.session_state.df.head())
        ...
        logger.info(f"### Successfully loaded data analysis agetn !###")
